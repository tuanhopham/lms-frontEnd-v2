<template>
  <div class="view">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="Only Admin">
                <el-switch v-model="onlyadmin"> </el-switch>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    <Panel>
      ...
      >
        <el-button size="small" icon="el-icon-fa-upload" type="primary"
        ...
        <el-row type="flex" justify="space-between">
          ...
          <el-col :span="4">
            <el-form-item label="End Number" prop="number_to" required>
              <el-input-number
                v-model="formGenerateUser.numberstyleWidth"
              ></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            ...
            <el-form-item :label="$t('m.User_Type')">
              <el-select v-model="user.admin_type">
                <el-option
                  ...
                  value="Regular User"
                ></el-option>
                <el-option label="Interviewer" value="Interviewer"></el-option>
