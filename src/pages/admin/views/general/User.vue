        ...
        <el-row type="flex" justify="space-between">
          ...
          <el-col :span="4">
            <el-form-item label="Start Number" prop="number_from" required>
              <el-input-number v-model="formGenerateUser.number_from" class=" styleWidth"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="End Number" prop="number_to" required>
              <el-input-number v-model="formGenerateUser.numberstyleWidth"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
