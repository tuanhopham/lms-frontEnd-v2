...
<el-dialog title="Edit Quizz" :visible.sync="isEditQuizz" :before-close="cancelQuiz" top="5vh" width="60%">
    <div style="height: 62vh;"  class="scroll-modal">
        ...
        saveQuiz(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    api["editSectionQuiz"](data)
                        .then(res => {
                            this.handleEditQUizz(res.data)
                            this.handleCloseDialog('isEditQuizz')
                        })
                        .catch(() => {});
                } else {
                    this.$error(
