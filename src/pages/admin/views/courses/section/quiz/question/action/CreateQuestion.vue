<template>
<el-dialog title="Create Quesiton" :visible.sync="isCreateQuestion" :before-close="cancelQuestion"  top="5vh" width="65%">

    <el-form :model="question" ref="question" :rules="rules" label-position="top" style="height: 62vh;" class="scroll-modal">
        <el-row :gutter="20">
            <el-col :span="24">
    ...
    <span slot="footer" class="dialog-footer">
        ...
        <el-button @click.native="saveQuestion('question')" type="primary">Submit</el-button>
    </span>
</el-dialog>
</template>
