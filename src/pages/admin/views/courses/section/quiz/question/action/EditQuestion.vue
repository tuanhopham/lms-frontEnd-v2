...
<el-dialog title="edit Quesiton" :visible.sync="isEditQuestion" :before-close="cancelQuestion" top="5vh" width="65%">
    ...
    <el-form :model="question" ref="editQuestion" :rules="rules" label-position="top" style="height: 62vh;" class="scroll-modal">
        <el-row :gutter="20">
            <el-col :span="24">
            ...
            <el-col :span="8">
                ...
                <el-input v-if="question.questionType == 'MAT'" v-model="oppositeAnswer" class="w-50 m-2" placeholder="Match" />
                    ...
                    <el-table :data="question.resultList" style="width: 100%">
                        ...
                        <el-table-column v-if="correctConditional" prop="isCorrect" label="IsCorrect" width="240" align="center">
                            <div slot-scope="scope">
                                <i v-if="question.resultList[scope.$index].isCorrect" class="el-icon-fa-check-square correctLabel"></i>
                                <i v-else class="el-icon-fa-minus-square incorrectLabel"></i>
                            </div>
                        </el-table-column>
                        <el-table-column v-if="question.questionType === 'MAT'" prop="matchAnswer" label="Match to" width="320" />
                        <el-table-column v-if="question.questionType === 'RANK'" prop="order" label="Order to" width="240" align="center" />
