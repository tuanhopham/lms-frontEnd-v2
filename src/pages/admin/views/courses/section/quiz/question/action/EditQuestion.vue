<template>
    <el-dialog title="edit Quesiton" :visible.sync="isEditQuestion" :before-close="cancelQuestion" top="5vh" width="65%">

        <el-form :model="question" ref="editQuestion" :rules="rules" label-position="top" style="height: 62vh;"
            class="scroll-modal">
            <el-row :gutter="20">
                <el-col :span="24">
                ...
                <el-col :span="8">
                    <el-form-item prop="questionType" label="Question Type" required>
                        <el-select placeholder="Quention Type" v-model="question.questionType" @change="changeType">
                ...
                <el-col v-if="question.mark >= 0" :span="8">
                    <el-form-item prop="mark" label="mark" required>
                        <el-input-number :min="0" placeholder="mark" v-model.number="question.mark" />
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="8">
                    ...
                    <el-input v-if="question.questionType == 'MAT'" v-model="oppositeAnswer" class="w-50 m-2"
                        placeholder="Match" />
                    <el-input v-if="question.questionType == 'RANK'" v-model="rank" class="w-50 m-2" placeholder="Order" />
                </el-col>
                <el-col :span="8" v-if="answerConditional">
                    <span class="marginBottom">
                        ...
                        <el-button v-if="editAnswer === true" type="primary"
                            @click.native="updateCheckAnswer">Update</el-button>
                    </span>
                </el-col>
                <el-col v-if="question.questionType === 'OE'" :span="24" class="marginBottom">
                    <el-select placeholder="Quention Type" v-model="question.problemId">
                ...
                <el-col :span="24" class="marginBottom">
                    <template v-if="checkRender">
                        <el-table :data="question.resultList" style="width: 100%">
                            ...
                            <el-table-column v-if="correctConditional" prop="isCorrect" label="IsCorrect" width="240"
                                align="center">
                            ...
                            <el-table-column v-if="question.questionType === 'MAT'" prop="matchAnswer" label="Match to"
                                width="320" />
                            <el-table-column v-if="question.questionType === 'RANK'" prop="order" label="Order to"
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button @click.native="saveQuestion('editQuestion')" type="primary">Submit</el-button>
        </span>
    </el-dialog>
</template>
        ...
        saveQuestion(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    api["editQuizQuestion"](this.quizId, data)
                        .then(res => {
                            this.handleCloseDialog('isEditQuestion')
                        })
                        .catch((error) => {
                            this.$error('The quiz has reached the maximum number of questions.' + error);
                        });
                } else {
                    this.$error(
