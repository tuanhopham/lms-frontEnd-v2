    ...
    <div class="view">
        <Panel :title="contestId ? this.$i18n.t('m.Contest_Problem_List') : this.$i18n.t('m.Problem_List')">
            ...
            <el-table v-loading="loading" element-loading-text="loading" ref="table" :data="problemList"
                ...
                <el-table-column width="100" label="Display ID">
                ...
                <el-table-column width="150" prop="create_time" label="Create Time">
                ...
                <el-table-column fixed="right" label="Operation" width="210">
