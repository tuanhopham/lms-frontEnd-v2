<template>
    <Row type="flex" justify="space-around">
        <Col :span="22">
        <Panel :padding="10">
            <div slot="title">{{ $t('m.Experience_Ranklist') }}</div>
            <div class="echarts">
...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                {
                    title: this.$i18n.t('m.Experience'),
                    align: 'center',
                    key: 'experience'
                },
                {
    ...
    methods: {
        getRankData(page) {
            ...
            api.getUserRank(offset, this.limit, RULE_TYPE.experience).then(res => {
                if (page === 1) {
