    ...
    <div v-if="website.allow_forum_post" class="flex-container">
        <div id="forumpost-main">
            ...
            <Card :padding="20" id="submit-reply" dis-hover>
                ...
                <Form ref="forumpost" :model="forumpost" :rules="ruleValidate" inline
                    ...
                    <FormItem :label="$t('m.Sort')" prop="sort">
                        <Select v-model="forumpost.sort" size="large" style="width:200px; margin-right: 20px;">
                            <Option v-for="(sort, index) in website.forum_sort" :value="index + 1" :key="sort.name">{{
                                sort.name }}</Option>
                        </Select>
                    </FormItem>
                ...
                <Form ref="forumpost" :model="forumpost" :rules="ruleValidate"
                    style="margin-left: 20px; margin-right: 20px; width: 100%;">
                ...
                <Row type="flex" justify="space-between">
                    ...
                    <Button type="warning" icon="md-create" :loading="submitting" @click="submitforumpost"
                        :disabled="forumpostSubmitDisabled" class="fl-right">
    ...
    methods: {
        ...
        submitforumpost() {
            ...
            api.submitFourmPost(data).then(res => {
                ...
                this.$router.push({ name: 'Forum-details', params: { forumpostID: res.data.data.id } }).catch(() => { })
            }, () => {
                this.submitting = false
            })
        },
