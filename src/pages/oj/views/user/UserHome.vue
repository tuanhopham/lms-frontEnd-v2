    ...
    <div class="container">
        ...
        <Card :padding="100">
            <div v-if="profile.user" :title="profile.real_name">
                ...
                <p v-if="profile.school" style="font-size: 1.2em;color: rgb(48 141 240);"><span
                        style="    border: 1px dotted rgb(229 233 236);padding: 5px;"><span
                            v-if="profile.major">{{ profile.major }} - </span> {{ profile.school }}</span></p>
                <p v-if="profile.mood">
                    {{ profile.mood }}
                </p>
                ...
                <div id="problems">
                    ...
                    <div v-if="this.count_tried" style="margin-top: 30px;">{{ $t('m.List_Tried_Problems') }}
                        ({{ this.count_tried }})
                        <Poptip v-if="refreshVisible" trigger="hover" placement="right-start">
                            <Icon type="ios-help-outline"></Icon>
                            <div slot="content">
