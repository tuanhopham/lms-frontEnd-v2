    ...
    <div class="flex-container">
        <div id="problem-main">
            ...
            <Panel :padding="40" shadow>
                ...
                <div id="problem-content" class="markdown-body" v-katex>
                    ...
                    <!-- {{$t('m.music')}} -->
                    <h3 class="title">{{ $t('m.Input') }} <span
                            v-if="problem.io_mode.io_mode == 'File IO'">({{ $t('m.FromFile') }}: {{ problem.io_mode.input
                            }})</span></h3>
                    <p class="content" v-html=problem.input_description></p>

                    <h3 class="title">{{ $t('m.Output') }} <span
                            v-if="problem.io_mode.io_mode == 'File IO'">({{ $t('m.ToFile') }}: {{ problem.io_mode.output
                            }})</span></h3>
                        ...
                        <div class="flex-container sample">
                            ...
                            <div class="sample-output">
                                <p class="title" style="font-size: 15px;">{{ $t('m.Sample_Output') }} #{{ index + 1 }}
                                    <a class="copy" v-clipboard:copy="sample.output" v-clipboard:success="onCopy"
                                        v-clipboard:error="onCopyError">
                                        <Icon type="md-clipboard"></Icon>
                                    </a>
                                </p>
                ...
                <Row type="flex" justify="space-between">
                    ...
                    <div class="status" v-if="statusVisible">
                        <template v-if="!this.contestID || (this.contestID && OIContestRealTimePermission)">
                            ...
                            <Tag v-if="this.contestID" type="dot" :color="submissionStatus.color"
                                title="Click để xem chi tiết"
                                @click.native="handleRoute('/status/' + submissionId + '?problem=' + problem._id + '&contest=' + contestID)">
                                {{ $t('m.' + submissionStatus.text.replace(/ /g, "_")) }} {{ this.resultSummary }}
                            </Tag>
                            <Tag v-else type="dot" :color="submissionStatus.color" title="Click để xem chi tiết"
                                @click.native="handleRoute('/status/' + submissionId + '?problem=' + problem._id)">
                                {{ $t('m.' + submissionStatus.text.replace(/ /g, "_")) }} {{ this.resultSummary }}
                            </Tag>
                        </template>
        ...
        <div id="right-column">
            ...
            <Card style="margin-top: 20px;" :padding="10" v-if="!this.contestID || OIContestRealTimePermission">
                <div slot="title" style="font-size: 16px;"><i data-v-20c86fbe="" class="ivu-icon ivu-icon-md-heart"
                ...
                <ul style="margin-left: 20px;margin-bottom: 10px;">
                    <li style="padding: 5px 0px;"><span style="color: green;">VPBank</span>: Nguyễn Văn Hiếu, STK:
                        146301158, chi nhánh Đông Đô</li>
                    <li style="padding: 5px 0px;"><span style="color: green;">MoMo</span>: <a style="color: #495060;"
                            target="_blank" href="https://me.momo.vn/nguyenvanhieu">me.momo.vn/nguyenvanhieu</a></li>
                    <li style="padding: 5px 0px;"><span style="color: green;">Paypal</span>: <a style="color: #495060;"
                            target="_blank" href="https://www.paypal.me/nguyenvanhieuvn">paypal.me/nguyenvanhieuvn</a></li>
                </ul>
